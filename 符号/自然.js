	...
	groups: [
		...
		},
		{
			...
			symbols: [
				...
				{char: "☀", name: "实心太阳", ename: "Solid Sun with Rays", tags: ['太阳系', '日', '光芒']},
				{char: "☼", name: "空心太阳", ename: "Hollow Sun with Rays", tags: ['太阳系', '日', '光芒']},
		...
		},
		{
			name: '抽象星形符号',
			symbols: [
				{char: "★", name: "实心星", ename: "Solid Star", tags: ["五角星", '五芒星', "实心星"]},
				{char: "☆", name: "空心星", ename: "Hollow Star", tags: ["五角星", '五芒星', "空心星"]},
				{char: "✡", name: "大卫之星", ename: "Star of David", tags: ["六角星", '六芒星']},
				{char: "✦", name: "实心四角星", ename: "Solid Four Pointed Star", tags: ["四角星", '四芒星']},
				{char: "✧", name: "空心四角星", ename: "Hollow Four Pointed Star", tags: ["四角星", '四芒星']},
				{char: "✩", name: "轮廓白星", ename: "Stress Outlined White Star", tags: ["五角星", '五芒星', "旋转星"]},
				{char: "✪", name: "实心圆空心星", ename: "Circled Hollow Star", tags: ["五角星", '五芒星', "带圈星"]},
				{char: "⍟", name: "空心圆实心星", ename: "APL Functional Symbol Circle Star", tags: ["五角星", '五芒星', '圈内星']},
				{char: "✫", name: "实心星空心圆", ename: "Open Centre Solid Star", tags: ["五角星", '五芒星']},
				{char: "✬", name: "空心星实心圆", ename: "Solid Centre Hollow Star", tags: ["五角星", '五芒星']},
				{char: "✭", name: "描边实心星", ename: "Outlined Solid Star", tags: ["五角星", '五芒星']},
				{char: "✮", name: "粗描边实心星", ename: "Heavy Outlined Solid Star", tags: ["五角星", '五芒星']},
				{char: "✯", name: "风车星", ename: "Pinwheel Star", tags: ["五角星", '五芒星']},
				{char: "✰", name: "阴影空心星", ename: "Shadowed Hollow Star", tags: ["五角星", '五芒星', "带影星"]},
				...
				{char: "⚝", name: "空心星", ename: "Outlined Hollow Star", tags: ['星形', '白色']},
		...
		},
		{
			name: '天气',
			symbols: [
				{char: "☀", name: "实心太阳", ename: "Solid Sun with Rays"},
				{char: "☼", name: "空心太阳", ename: "Hollow Sun with Rays"},
				...
				{char: "⛇", name: "实心雪人", ename: "Solid Snowman", tags: ['雪人', '冬天', '雪']},
