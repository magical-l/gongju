...
EMOJI_PHRASE = {
    ...
    'BANKNOTE WITH YEN SIGN': '带元符号的钞票',
    ...
    # BAR 不写横竖（原文没说，跟 STROKE 一样不替它加信息）；只有 LONG BAR 写「长杠」
    # FROM BAR 的直译是「从杠出发的…」；「平尾X箭头」是富化层主名（2026-09-18）
    'LEFTWARDS ARROW FROM BAR': '从杠出发的左箭头',
    'UPWARDS ARROW FROM BAR': '从杠出发的上箭头',
    'RIGHTWARDS ARROW FROM BAR': '从杠出发的右箭头',
    'DOWNWARDS ARROW FROM BAR': '从杠出发的下箭头',
    'LEFTWARDS TWO-HEADED ARROW FROM BAR': '从杠出发的左双重箭头',
    'UPWARDS WHITE ARROW FROM BAR': '从杠出发的空心上箭头',
    'NORTH WEST ARROW FROM BAR': '从杠出发的西北箭头',
    'NORTH EAST ARROW FROM BAR': '从杠出发的东北箭头',
    'SOUTH EAST ARROW FROM BAR': '从杠出发的东南箭头',
    'SOUTH WEST ARROW FROM BAR': '从杠出发的西南箭头',
    'NORTH WEST ARROW TO LONG BAR': '指向长杠的左上箭头',
    'LEFTWARDS ARROW TO BAR': '指向杠的左箭头',
    'RIGHTWARDS ARROW TO BAR': '指向杠的右箭头',
    'DOWNWARDS BLACK ARROW TO BAR': '指向杠的实心下箭头',
    'LEFTWARDS ARROW TO BAR OVER RIGHTWARDS ARROW TO BAR': '左箭头到杠压右箭头到杠',
    'NORTH WEST ARROW TO CORNER': '指向左上角落的箭头',
    'SOUTH EAST ARROW TO CORNER': '指向右下角落的箭头',
    'LEFTWARDS TRIANGLE-HEADED ARROW TO BAR': '指向杠的左三角箭头',
    'UPWARDS TRIANGLE-HEADED ARROW TO BAR': '指向杠的上三角箭头',
    'RIGHTWARDS TRIANGLE-HEADED ARROW TO BAR': '指向杠的右三角箭头',
    'DOWNWARDS TRIANGLE-HEADED ARROW TO BAR': '指向杠的下三角箭头',
    'NORTH WEST TRIANGLE-HEADED ARROW TO BAR': '指向杠的左上三角箭头',
