...
本文件导出三个结构：
  ...
  KEEP    保留原样的词集合。判据：**不是英语实词**，而是某个文字系统的
...
KEEP 的判据展开（**别把真英文词塞进来**）：
  ...
  WITH / FORM / VESSEL / DAMAGED / INSULAR / DOTLESS …
  见文件末尾 ENGLISH 集合，那是「确认为真英文词」的黑名单，KEEP 与它互斥。
...
KEEP = (set().union(_KEEP_SYLLABLE, _KEEP_LETTER, _KEEP_CUNEIFORM, _KEEP_SCRIPTNAME, _KEEP_CODE, _KEEP_TRANSLIT)) - set("""
