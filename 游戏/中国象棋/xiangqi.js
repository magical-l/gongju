...
const 中国象棋默认配置 = {
	...
	`,
	棋子类型: {
		'帅': {显示: '\u{1FA60}', 技能: ['杀敌', '步战四方', '守营'], 玩家: '红方玩家'},
		'仕': {显示: '\u{1FA61}', 技能: ['杀敌', '护卫', '守营'], 玩家: '红方玩家'},
		'相': {显示: '\u{1FA62}', 技能: ['杀敌', '象行田', '塞象眼', '水太深'], 玩家: '红方玩家'},
		'马': {显示: '\u{1FA63}', 技能: ['杀敌', '马行日', '绊马脚'], 玩家: '红方玩家'},
		'车': {显示: '\u{1FA64}', 技能: ['杀敌', '轮子', '挡我者死'], 玩家: '红方玩家'},
		'炮': {显示: '\u{1FA65}', 技能: ['杀敌', '轮子', '隔山打牛'], 玩家: '红方玩家'},
		'兵': {显示: '\u{1FA66}', 技能: ['杀敌', '勇往直前', '过河卒'], 玩家: '红方玩家'},
		'将': {显示: '\u{1FA67}', 技能: ['杀敌', '步战四方', '守营'], 玩家: '黑方玩家'},
		'士': {显示: '\u{1FA68}', 技能: ['杀敌', '护卫', '守营'], 玩家: '黑方玩家'},
		'象': {显示: '\u{1FA69}', 技能: ['杀敌', '象行田', '塞象眼', '水太深'], 玩家: '黑方玩家'},
		'馬': {显示: '\u{1FA6A}', 技能: ['杀敌', '马行日', '绊马脚'], 玩家: '黑方玩家'},
		'車': {显示: '\u{1FA6B}', 技能: ['杀敌', '轮子', '挡我者死'], 玩家: '黑方玩家'},
		'砲': {显示: '\u{1FA6C}', 技能: ['杀敌', '轮子', '隔山打牛'], 玩家: '黑方玩家'},
		'卒': {显示: '\u{1FA6D}', 技能: ['杀敌', '勇往直前', '过河卒'], 玩家: '黑方玩家'}
	},
	玩家顺序: [红方id, 黑方id],
	规则: ['不能叠加棋子', '王不见王', '斩将']
};
