	...
	parts: [
		...
		},
		{
			...
			parts: [
				...
				月份汉字合字, 日期汉字合字, 钟点汉字合字,
				{name: '‘正’字计数标记', from: 0x1D372, to: 0x1D376},//Counting Rod Numerals>Ideographic tally marks
				{
					name: '苏州码子',
					parts: [
						'〇',//3007
		...
		},
		{
			...
			parts: [
				...
				},
				{
					name: '用作其他汉字额外附加的标记',
					parts: [
						{from: 0x3192, to: 0x319F}//Kanbun区中的标记
					]
				}
			]
		},
		...
		{
			name: '汉字结构符', ename: 'Ideographic Description Characters', intro: '每个都代表一种特定的汉字结构关系',
			from: 0x2FF0, to: 0x2FFF//⿰⿱⿲⿳⿴⿵⿶⿷⿸⿹⿺⿻等
		},
		{name: '笔画', ename: 'CJK Strokes', from: 0x31C0, to: 0x31EF},
		{
			name: '标点',
			parts: [//按常用程度排序
				{
	...
	parts: [
		...
		},
		{
			...
			parts: [
				...
				'㆐',//3190，象形文字注释链接标记/IDEOGRAPHIC ANNOTATION LINKING MARK
				'㆑'//3191，象形文字注释反向标记/IDEOGRAPHIC ANNOTATION REVERSE MARK
			]
		},
		{
			name: '合字',
