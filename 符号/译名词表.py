...
# 不算挡路词，所在条目永久漏报。同族词（MAN/EWE/RAM/SOW/COW/WINE/WOOL…）
# 与 _KEEP_* 里的音节名/字母名重名，回收后会连带翻出几处本意保留转写的条目，
# 属预期代价。
ENGLISH = set("""

    AFFRICATION AFRICAN ANIMAL ASPER ASPIRATION ASTROLOGICAL BAT BATHTUB BEAVER BED
    BEE BEGIN BIBLICAL BIDENTAL BIG BILABIAL BILLIONS BOX BUT CABBAGE
    CALL CAP CAR CASKET CAT CRUCIFORM CRYPTOGRAMMIC CULTIVATION CUP CUT
    DAY DEBIT DIE DNA DOT DOWN EGYPTOLOGICAL EPENTHETIC EWE FAN
    FAX FEATHER FOOTSTOOL FOX FRANKS FULL FUR GAP GOAL HAT
    HEAD HELMET HEXIFORM HIT HOT HOUSE JUDGE KILLER KORANIC LABIAL
    LABIALIZATION LAND LARYNGEAL LATINATE LAW LAZY LEADING LEGGED LENIS LIGATING
    LIP LIS LOT LOTUS MAN MAP MAY MID MONOCULAR MONOGRAM
    MONOGRAPH MOOSE MORPHOLOGICAL MULTIOCULAR NOR NOT NUT OCCLUSION PALATALIZATION PEN
    PERSON PHASE PIE PIN POLISH POP POSSESSION POSTPOSITION POT PREFACE
    QUADRUPLE RAM RAMS RAP RAT REX RHOTIC SAW SAY SECANT
    SEE SEMI SET SIGMOID SINOLOGICAL SOON SOW SUBLINEAR SUN SUPRALINEAR
    TEENS THAN THE THONG TIE TIP VOCALIZATION VOICING WAX WAY
    WET WINE WOOL WORD
    ...
    BRONZE BULL BY CANCELLATION CARET CAUDATE CENTRALIZATION CHARIOT CHURCH CIRCLED
    ...
    DRY EAR EASTERN EAT EGG EIGHTY ELLIPSIS EMPHASIS EMPHATIC ENCLOSURE
    ENCLOSURES END ENUMERATION EPOCH EQUID ETERNITY EVEN EXTRA FACTOR FATIGUE
    FEMININE FIFTY FITKO FLAME FLEURON FLOWER FOR FORMS FORTY FOURTH
    FOURTHS FRAGMENT FRAME FRICATIVE FROM GARMENT GEMINATE GENITIVE GOAT GOLD
    GREATER HANDLE HEADSTROKE HYPHENATION ICE ID IF INDEPENDENT INDICATOR INDIRECT
    ...
    NASAL NEUTRAL NEW NINETY NORTHERN NOTCH OAK ODD OF OIL
    OK OLD OLIVE ONE OPTION OR ORNAMENTS OUT OVERLINE OVERLONG
    ...
    TWENTY TWIG TWO UNASPIRATED UNBLENDED UNIT UNKNOWN UP UPRIGHT UPTURN
